...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('asset_admin') }}/plugins/iCheck/square/blue.css">
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url('/login') }}"><b>Coza</b>Store</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Register a new membership</p>
        @include('component.alert')
        <form action="{{ url('register') }}" method="post" style="margin-bottom: 20px;">
            @csrf
        ...
        <a href="{{ url('login') }}" class="text-center d-block">Already Member</a>
...
<!-- iCheck -->
<script src="{{ asset('asset_admin') }}/plugins/iCheck/icheck.min.js"></script>
<script>
    $(function () {
        $('input').iCheck({
